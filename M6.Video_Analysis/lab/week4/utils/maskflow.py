...
# ======== PLEASE MODIFY ========
# where is the repo
repoRoot = '/ghome/group03/mcv-m6-2023-team6/week4/MaskFlownet'
# to CUDA\vX.Y\bin
...
def predict_video_flow(video_filename, batch_size, pipe, resize=None):
    ...
    flow_video = [flow for flow, occ_mask, warped in
                  pipe.predict(prev_frames, new_frames, batch_size=batch_size, resize=resize)]
